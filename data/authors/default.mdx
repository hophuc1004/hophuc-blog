...
- Responsibilities:
  ...
  - Component setup, implemented responsive designs and ensured optimal user experiences.
- **Tech stack:** ReactJS, Node.js, gRPC, Redis, PostgreSQL
...
In **May 2025**, with one month of preparation, I achieved an **IELTS Band 5.0** through self-study.
